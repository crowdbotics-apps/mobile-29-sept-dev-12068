...
export default function apiReducer(state = initialState, action) {
  switch (action.type) {
    ...
    case types.API_V1_GHHFJHFHG_LIST:
    case types.API_V1_GHHFJHFHG_LIST_SUCCEEDED:
    case types.API_V1_GHHFJHFHG_LIST_FAILED:
    case types.API_V1_GHHFJHFHG_CREATE:
    case types.API_V1_GHHFJHFHG_CREATE_SUCCEEDED:
    case types.API_V1_GHHFJHFHG_CREATE_FAILED:
    case types.API_V1_GHHFJHFHG_READ:
    case types.API_V1_GHHFJHFHG_READ_SUCCEEDED:
    case types.API_V1_GHHFJHFHG_READ_FAILED:
    case types.API_V1_GHHFJHFHG_UPDATE:
    case types.API_V1_GHHFJHFHG_UPDATE_SUCCEEDED:
    case types.API_V1_GHHFJHFHG_UPDATE_FAILED:
    case types.API_V1_GHHFJHFHG_PARTIAL_UPDATE:
    case types.API_V1_GHHFJHFHG_PARTIAL_UPDATE_SUCCEEDED:
    case types.API_V1_GHHFJHFHG_PARTIAL_UPDATE_FAILED:
    case types.API_V1_GHHFJHFHG_DELETE:
    case types.API_V1_GHHFJHFHG_DELETE_SUCCEEDED:
    case types.API_V1_GHHFJHFHG_DELETE_FAILED:
